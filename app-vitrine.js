/* =====================================================
   ARIMAR UTILIDADES — v4 "Vitrine"
   Link in bio com vitrine de produtos detalhada.
===================================================== */
...
function renderVitrine() {
  const shelf = document.getElementById("vitrine-shelf");
  shelf.innerHTML = products.map((p, i) => {
...
function setupReveal() {
  const targets = document.querySelectorAll(".produto, .procura, .store, .map__card, .hours__card, .social");
